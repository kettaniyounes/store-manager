...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="HistoricalCustomerSegment",
            fields=[
                (
                    "id",
                    models.BigIntegerField(
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="Segment Name"
                    ),
                ),
                (
                    "description",
            ...
            options={
                "verbose_name": "historical Customer Segment",
                "verbose_name_plural": "historical Customer Segments",
                "ordering": ("-history_date", "-history_id"),
                "get_latest_by": ("history_date", "history_id"),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="Program Name"
                    ),
                ),
                (
                    "description",
            ...
            options={
                "verbose_name": "historical Loyalty Program",
                "verbose_name_plural": "historical Loyalty Programs",
                "ordering": ("-history_date", "-history_id"),
                "get_latest_by": ("history_date", "history_id"),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
