...
class WebhookEndpointViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return WebhookEndpoint.objects.filter(created_by=self.request.user.pk)
...
class WebhookDeliveryViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        return WebhookDelivery.objects.filter(endpoint__created_by=self.request.user.pk)
...
class APIKeyViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return APIKey.objects.filter(user=self.request.user.pk)
...
class BulkOperationViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return BulkOperation.objects.filter(created_by=self.request.user.pk)
...
class ExternalIntegrationViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ExternalIntegration.objects.filter(created_by=self.request.user.pk)
