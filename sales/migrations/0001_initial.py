    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, verbose_name="Apply to All Products"
                    ),
                ),
                (
                    "customer_tiers",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "total_sales_volume",
                    models.IntegerField(default=0, verbose_name="Total Items Sold"),
                ),
                (
                ...
                (
                    "unique_customers",
                    models.IntegerField(default=0, verbose_name="Unique Customers"),
                ),
                (
                    "new_customers",
                    models.IntegerField(default=0, verbose_name="New Customers"),
                ),
                (
                    "repeat_customers",
                    models.IntegerField(default=0, verbose_name="Repeat Customers"),
                ),
                (
                    "cash_sales",
                    models.DecimalField(
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Top Selling Product ID"
                    ),
                ),
                (
                    "top_selling_category_id",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Top Selling Category ID"
                    ),
                ),
                (
                    "best_salesperson_id",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Best Salesperson ID"
                    ),
                ),
                (
                    "generated_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "forecast_start_date",
                    models.DateField(verbose_name="Forecast Start Date"),
                ),
                (
                    "forecast_end_date",
                    models.DateField(verbose_name="Forecast End Date"),
                ),
                (
                    "historical_data_start",
                    models.DateField(verbose_name="Historical Data Start Date"),
                ),
                (
                    "predicted_sales_quantity",
                    models.IntegerField(
                        default=0, verbose_name="Predicted Sales Quantity"
                    ),
                ),
                (
            ...
            options={
                "verbose_name": "historical Sales Forecast",
                "verbose_name_plural": "historical Sales Forecasts",
                "ordering": ("-history_date", "-history_id"),
                "get_latest_by": ("history_date", "history_id"),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "return_date",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="Return Date"
                    ),
                ),
                (
                    "reason",
        ...
        migrations.CreateModel(
            name="HistoricalSalesReturnItem",
            fields=[
                (
                    "id",
                    models.BigIntegerField(
                ...
                (
                    "quantity_returned",
                    models.IntegerField(verbose_name="Quantity Returned"),
                ),
                (
                    "unit_price",
                    models.DecimalField(
                ...
                (
                    "can_resell",
                    models.BooleanField(default=True, verbose_name="Can Resell"),
                ),
            ...
            options={
                "verbose_name": "historical Sales Return Item",
                "verbose_name_plural": "historical Sales Return Items",
                "ordering": ("-history_date", "-history_id"),
                "get_latest_by": ("history_date", "history_id"),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "return_number",
                    models.CharField(
                        db_index=True, max_length=50, verbose_name="Return Number"
                    ),
                ),
                (
                    "return_date",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["start_date"], name="period_start_idx"),
        ),
        migrations.AddIndex(
            model_name="financialperiod",
            index=models.Index(fields=["period_type"], name="period_type_idx"),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["generated_at"], name="analytics_date_idx"),
        ),
        migrations.AddIndex(
            model_name="salesforecast",
            index=models.Index(
                fields=["forecast_start_date"], name="forecast_date_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="saletransaction",
            index=models.Index(
                fields=["sale_date", "status"], name="sale_date_status_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="saletransaction",
            index=models.Index(
                fields=["salesperson", "sale_date"], name="salesperson_date_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="saletransaction",
            index=models.Index(
                fields=["customer", "sale_date"], name="customer_date_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="saletransaction",
            index=models.Index(
                fields=["store", "sale_date"], name="store_sale_date_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="saletransaction",
        ...
        migrations.AddIndex(
            model_name="saletransaction",
            index=models.Index(fields=["transaction_id"], name="transaction_idx"),
        ),
        migrations.AlterUniqueTogether(
            name="saletransaction",
        ...
        migrations.AddIndex(
            model_name="salesreturn",
            index=models.Index(fields=["return_date"], name="return_date_idx"),
        ),
        migrations.AddIndex(
            model_name="salesreturn",
            index=models.Index(fields=["status"], name="return_status_idx"),
        ),
        migrations.AlterUniqueTogether(
            name="salesreturn",
            unique_together={("return_number",)},
        ),
        migrations.AddIndex(
            model_name="saleitem",
            index=models.Index(
                fields=["store", "product"], name="saleitem_store_product_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="saleitem",
            index=models.Index(
                fields=["store", "created_at"], name="saleitem_store_date_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="saleitem",
        ...
        migrations.AddIndex(
            model_name="saleitem",
            index=models.Index(fields=["created_at"], name="saleitem_date_idx"),
        ),
        migrations.AlterUniqueTogether(
            name="taxreport",
            unique_together={("period", "store")},
