    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "triggered_value",
                    models.DecimalField(
                        decimal_places=2, max_digits=15, verbose_name="Triggered Value"
                    ),
                ),
                ("message", models.TextField(verbose_name="Alert Message")),
                (
                    "is_acknowledged",
                    models.BooleanField(default=False, verbose_name="Is Acknowledged"),
                ),
                (
                    "acknowledged_at",
                    models.DateTimeField(
                ...
                (
                    "triggered_at",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="Triggered At"
                    ),
                ),
                (
                    "acknowledged_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "analysis_date",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="Analysis Date"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "next_analysis_date",
                    models.DateTimeField(verbose_name="Next Analysis Date"),
                ),
                ("created_at", models.DateTimeField(blank=True, editable=False)),
                ("updated_at", models.DateTimeField(blank=True, editable=False)),
                ("history_id", models.AutoField(primary_key=True, serialize=False)),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="dashboard_type_public_idx",
                    ),
                    models.Index(
                        fields=["owner", "dashboard_type"],
                        name="dashboard_owner_type_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.DecimalField(
                        decimal_places=2, max_digits=15, verbose_name="Metric Value"
                    ),
                ),
                ...
                (
                    "snapshot_date",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="Snapshot Date"
                    ),
                ),
                (
                    "metadata",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["metric", "snapshot_date"],
                        name="metric_snapshot_date_idx",
                    ),
                    models.Index(
                        fields=["store", "snapshot_date"],
                        name="store_snapshot_date_idx",
                    ),
                    models.Index(
                        fields=["period_start", "period_end"],
                        name="snapshot_period_idx",
                    ),
                ],
            },
        ),
