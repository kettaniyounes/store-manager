    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_amount', models.DecimalField(decimal_places=2, help_text='Total amount of the purchase Order (calculated)', max_digits=10, verbose_name='Total Amount')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('supplier', models.ForeignKey(help_text='Supplier for this purchase order.', on_delete=django.db.models.deletion.CASCADE, related_name='purchase_orders', to='suppliers.supplier', verbose_name='Supplier')),
            ],
            options={
